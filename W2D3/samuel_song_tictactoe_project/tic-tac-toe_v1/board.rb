...
class Board
    ...
    def win_diagonal?(mark)
        ...
        diag_1_mark_1 = @grid[0][0]
        diag_1_mark_2 = @grid[1][1]
        diag_1_mark_3 = @grid[2][2]

        diag_2_mark_1 = @grid[0][2]
        diag_2_mark_2 = @grid[1][1]
        diag_2_mark_3 = @grid[2][0]

        diag_1 = false if diag_1_mark_1 != mark || diag_1_mark_2 != mark || diag_1_mark_3 != mark
        diag_2 = false if diag_2_mark_1 != mark || diag_2_mark_2 != mark || diag_2_mark_3 != mark
